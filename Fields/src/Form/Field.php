...
class Field extends Form
{
     ...
     * @return Field
     */
    public function __construct(array $models, array $validators = [], array $fieldModels = [], array $fields = null, $action = null, $method = 'post')
    {
        ...
        foreach ($fieldModels as $key => $fieldModel) {
            ...
            $fields[1]['model_type_cur_' . ($key + 1)] = [
                ...
                'marked'     => ((null != $fieldModel['type_field']) && (null != $fieldModel['type_value'])) ? $fieldModel['type_field'] . '|' . $fieldModel['type_value'] : null
            ];
